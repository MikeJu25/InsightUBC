...
// TODO: implement!
document.getElementById("submit-button").addEventListener("click", function () {   // check late
    let queryExtracted = CampusExplorer.buildQuery();
    CampusExplorer.sendQuery(queryExtracted).then(function (result){
